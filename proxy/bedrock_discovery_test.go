...
func TestDedupeSortedModelIDs(t *testing.T) {
	foundation := []string{
		"amazon.nova-lite-v1:0",
		"meta.llama3-8b-instruct-v1:0",
		"amazon.nova-lite-v1:0", // dup within foundation
	}
	profiles := []string{
		"us.amazon.nova-lite-v1:0",
		"amazon.nova-lite-v1:0", // dup across foundation+profiles
		"",                      // empty dropped
		"us.deepseek.r1-v1:0",
	}
	got := dedupeSortedModelIDs(foundation, profiles)
	want := []string{
		"amazon.nova-lite-v1:0",
		"meta.llama3-8b-instruct-v1:0",
		"us.amazon.nova-lite-v1:0",
